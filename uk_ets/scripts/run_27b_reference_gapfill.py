#!/usr/bin/env python3
"""Run the frozen 27B reference policy on interleaved gap-fill windows."""
...
class WindowSpec:
    ...
    val_end: str
    test_end: str
    intended_gap_fill: str


WINDOWS = [
    WindowSpec("G0", "2024-05-20", "2025-05-20", "2026-01-22", "2025-05-21 to 2025-06-30"),
    WindowSpec("G1", "2023-09-16", "2024-09-15", "2025-05-20", "2024-09-17 to 2024-10-27"),
    WindowSpec("G2", "2023-01-12", "2024-01-12", "2024-09-15", "2024-01-13 to 2024-02-22"),
    WindowSpec("G3", "2022-05-10", "2023-05-10", "2024-01-12", "2023-05-11 to 2023-06-20"),
]
...
def main() -> int:
    ...
    for window in WINDOWS:
        print(
            f"Running {window.name} ({window.train_end} / {window.val_end} / {window.test_end}) "
            f"targeting {window.intended_gap_fill}",
            flush=True,
        )
        ...
        rows.append(
            {
                ...
                "val_end": window.val_end,
                "test_end": window.test_end,
                "intended_gap_fill": window.intended_gap_fill,
                "run_dir": str(run_dir),
                **metrics,
            }
        )
