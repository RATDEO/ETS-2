...
def _config_with_previous_llm_system(config_raw: Mapping[str, Any]) -> dict[str, Any]:
    ...
    online_memory_policy_cfg = copy.deepcopy(cot_cfg.get("online_memory_policy", {}) or {})
    online_memory_policy_cfg["enabled"] = False
    cot_cfg["online_memory_policy"] = online_memory_policy_cfg
