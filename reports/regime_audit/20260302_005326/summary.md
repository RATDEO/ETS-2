...
Ex post only. These use the same sample to choose the best model per regime bucket.

```text
         regime_family  oracle_path_mse  n_buckets
      trend_vol_regime        20.378191          6
sentiment_alignment_5d        20.404056          3
     volatility_regime        20.475664          2
      trend_regime_20d        20.502978          3
```
